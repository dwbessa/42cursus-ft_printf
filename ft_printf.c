...
/*   Updated: 2023/10/20 13:51:49 by dbessa           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	ft_printf("Eu sou o Daniel, mas pode me chamar de %c. %s, tenho %d anos e %umg de peso.\nMinha idade em hexadecimal é %x ou %X.\nTenho %i%% de bateria e o endereço de memória da minha idade é %p.\nObrigado por ler até aqui.\n\n", 'D', "Bessa", x, 4294967295, x, x, 97, ptr);
